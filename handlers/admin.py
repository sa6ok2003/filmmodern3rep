...
import sqlite3
from .sqlit import info_members, reg_one_channel, reg_channels,del_one_channel,cheak_traf,obnovatrafika,reg_admin,list_adminov,obnovatrafika2,cheak_traf2,cheak_person,obnova_pers
